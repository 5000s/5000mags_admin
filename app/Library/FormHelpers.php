...
class FormHelpers {
    ...
    static function  __input( $type , $value , $param, $prop = "" )
    {
	    $validation = '' ;
	    if($param['validation'] !='');
        ...
        switch ($type)
        {
            default:
            case 'text':
            	$form = '<input '.$prop.' type="text" name="'.$param['field'].'" value="'. $value .'" class="input-sm form-control" '.$validation.' />';

            	break;
            case 'text':
            	$form = '<input '.$prop.' type="text" name="'.$param['field'].'" value="'. $value .'" class="input-sm form-control CrudEngineColor" '.$validation.' />';
            	break;
            case 'password':
            	$form = '
            ...
            case 'text':
            	...
            	break;
            case 'timestamp':
            	$form = '<input '.$prop.' type="text" name="'.$param['field'].'" value="'. $value .'" class="input-sm form-control CrudEngineDateTime"  '.$validation.'/>';
            	break;
            case 'date':
            	$form = '
