...
class ReceivertypeController extends Controller {
	...
	public $module = 'receivertype';
	static $per_page	= '50';

	public function __construct()
	{		
		parent::__construct();
		$this->model = new Receivertype();	
		
		$this->info = $this->model->makeInfo( $this->module);	
		$this->data = array(
			'pageTitle'	=> 	$this->info['title'],
			'pageNote'	=>  $this->info['note'],
			'pageModule'=> 'receivertype',
	...
	public static function display(  )
	{
		...
		$model  = new Receivertype();
		$info = $model::makeInfo('receivertype');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('receivertype.public.view',$data);			
			}			
		} 
		else {
			...
			return view('receivertype.public.index',$data);	
		}
