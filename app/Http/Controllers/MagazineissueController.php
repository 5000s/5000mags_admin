...
class MagazineissueController extends Controller {
	...
	public static function display(  )
	{
		...
		$model  = new Magazineissue();
		$info = $model::makeInfo('magazineissue');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('magazineissue.public.view',$data);
			}
		}
		else {
			...
			return view('magazineissue.public.index',$data);
		}
