...
Route::get('/moduledata/edit', [ModuleDataController::class, 'index']);
Route::post('/moduledata/edit', [ModuleDataController::class, 'index']);
Route::post('/moduledata/save', [ModuleDataController::class, 'save']);
